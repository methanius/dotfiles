# Neovim — workstation-user role contribution.
#
# Also contributes the neovim-nightly overlay to `flake.dendritic.overlays`
# (option α) so the workstation-user toolchain pulls in nightly nvim without
# having to enumerate overlays in a separate file.
{ inputs, ... }:
{
